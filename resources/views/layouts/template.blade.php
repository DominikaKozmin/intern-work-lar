...
<body id="page-top">
    ...
    <nav class="navbar navbar-expand-lg navbar-dark text-uppercase sticky-top" style="background: #004696;" id="mainNav">
      <a href="/" class="nav-link active m-2 menu-item"><img src="{{ asset('img/logo/workinthewest-drugie-2-1.png') }}" alt=""></a>
        <div class="container">
