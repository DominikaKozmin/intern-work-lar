...
<div class="container">
    ...
    <div class="d-flex justify-content-center">
        <div class="bg-white p-5" style="width: 66.6666%">
            <div>
                <div class="fs-3 text-center pt-5 pb-4">Rejestracja pracodwacy</div>
            </div> 
            <form method="POST" action="{{ url('/register-employer') }}">
                @csrf
                <div>
                    <div class="py-2">
                    ...
                    <div class="py-2">
                        ...
                        <input type="text" class="form-control" name='company_name' placeholder="Nazwa firmy">
                    </div>
                    <div class="py-2">
                        <label>Hasło</label>
